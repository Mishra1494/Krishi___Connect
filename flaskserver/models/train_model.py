...
try:
    ...
    file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'crop_data_synthetic_realistic.csv')
    ...
    for stage in growth_stages:
        ...
        rf = RandomForestRegressor(n_estimators=15, max_depth=10, random_state=1, n_jobs=-1)
